...
import { Video, Mail, Lock, Sparkles, ArrowRight } from "lucide-react";
        ...
        <div className="bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-xl border border-yellow-600/20 rounded-2xl shadow-2xl shadow-yellow-500/10 p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <a href="/forgot-password" className="text-xs text-yellow-500 hover:text-yellow-400 transition-colors">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
            ...
            <Button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-400 hover:to-yellow-500 text-black font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg shadow-yellow-500/30 flex items-center justify-center gap-2"
            >
              Sign In
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gradient-to-br from-gray-900/90 to-black/90 text-gray-500">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              type="button"
              className="flex items-center justify-center gap-2 py-3 px-4 bg-black/50 border border-yellow-600/20 rounded-lg text-white hover:border-yellow-600/40 transition-all duration-300 hover:scale-105"
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400 text-sm">
              ...
              <a href="/signup" className="text-yellow-500 hover:text-yellow-400 font-medium transition-colors">
                Sign up
              </a>
            </p>
          </div>
