...
import { Video, Mail, Lock, Sparkles, ArrowRight, Loader } from "lucide-react";
        ...
        <div className="bg-linear-to-br from-gray-900/90 to-black/90 backdrop-blur-xl border border-yellow-600/20 rounded-2xl shadow-2xl shadow-yellow-500/10 p-6 sm:p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-linear-to-br from-gray-900/90 to-black/90 text-gray-500">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="cursor-pointer flex items-center justify-center gap-2 py-3 px-4 bg-black/50 border border-yellow-600/20 rounded-lg text-white hover:border-yellow-600/40 transition-all duration-300 hover:scale-105"
            >
            ...
            <button
              type="button"
              onClick={() => toast.info("Not Functionable")}
              className="cursor-pointer flex items-center justify-center gap-2 py-3 px-4 bg-black/50 border border-yellow-600/20 rounded-lg text-white hover:border-yellow-600/40 transition-all duration-300 hover:scale-105"
            >
