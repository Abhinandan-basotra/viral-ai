        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="group relative p-8 rounded-2xl bg-linear-to-br from-yellow-900/10 to-gray-900/20 border border-yellow-600/20 hover:border-yellow-600/60 transition-all duration-300 hover:scale-105 text-center">
                <div className={`w-20 h-20 mx-auto mb-4 rounded-full bg-linear-to-br ${platform.color} flex items-center justify-center group-hover:rotate-12 transition-transform duration-300`}>
